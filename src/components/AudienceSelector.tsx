                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 p-4 bg-[#F8FAFB] rounded-2xl border border-[#E8EDF2]">
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    <a
                      ...
                      className="flex items-center justify-center sm:justify-start gap-2 bg-[#0F172A] text-white py-2 px-4 rounded-xl hover:bg-slate-800 transition-colors shadow-sm"
                    >
